...
/* Definiciones para encabezados PKZIP */
#define ZIPMAG 0x4b50           /* dos bytes iniciales  */
#define LOCREM 0x0403           /* siguientes 2 bytes en firma zip */
#define LOCSIG 0x04034b50L      /* firma completa */
 ...
 **/
uint64_t updcrc(unsigned char *s, uint64_t n);
