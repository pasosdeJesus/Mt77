...
prueba2 () {
    ...
    (../buscador -l "$indice" $conocereis_l1 ;
     ...
     ../operaindice lista "$indice" ) | grep -v "\"fecha\":" >> r1.out 2>&1
...
prueba3 () {
    ...
    limpiar r1-u8
    ../indexador r1-u8.indice t.indice "http://r/" r1-utf8.txt   #1
...
prueba8 () {
    ...
    limpiar ro
    ../indexador -l ro.indice t.indice "http://r/" r1-latin1.txt r2-latin1.txt  #1
...
# TODO: poner nombres mas relevantes a estas funciones
prueba1
prueba2
prueba3
prueba4
