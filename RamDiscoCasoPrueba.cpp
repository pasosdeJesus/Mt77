...
void RamDiscoCasoPrueba::prueba_escribePlano()
{
        ...
        docs.push_back(Doc("ejemplo.txt", "12345678901234567890123456789012",
                           "2009-09-30"));
        escribePlano(*rm, docs, "prueba.indice", "prueba.relacion");
...
void RamDiscoCasoPrueba::prueba_mezclaDiscoRam()
{
        ...
        try {
                ...
                sis1.str("");
                cout << "1" << endl;
                mezclaDiscoRam(sis1, a2, 0, sos, false, false, NULL, NULL);
                ...
                sis1.str("\n");
                cout << "3" << endl;
                mezclaDiscoRam(sis1, a2, 0, sos, true, true, NULL, NULL);
                CPPUNIT_ASSERT(sos.str() == " \n" );
                ...
                sis1.clear();
                sis1.str("x");
                CPPUNIT_ASSERT_THROW(mezclaDiscoRam(sis1, a2, 0, sos, false, false, NULL, NULL),
                                     std::string);
                ...
                //cout << "ps9" << endl;
                mezclaDiscoRam(sis1, a2, 0, sos, true, false, NULL, NULL);
                ...
                a2 = new NodoTrieS("b", NULL, NULL, Pos(2,2));
                a2 = new NodoTrieS("a", NULL, a2);
                mezclaDiscoRam(sis1, a2, 0, sos, false, true, NULL, NULL);
                ...
                sos.clear();
                sos.str("");
                mezclaDiscoRam(sis1, nab, 0, sos, true, true, NULL, NULL);
                delete naa;
                delete nab;
                ...
                //llena_ss(sis2, naa);
                mezclaDiscoRam(sis1, naa, 0, sos, true, true, NULL, NULL);
                delete naa;
                nb = new NodoTrieS("b");
                ...
                //llena_ss(sis2, nb);
                mezclaDiscoRam(sis1, nb, 0, sos, true, true, NULL, NULL);
                delete nb;
                nb = new NodoTrieS("b", NULL, NULL, Pos(1,1));
                ...
                delete na;
                na = new NodoTrieS("a");
                mezclaDiscoRam(sis1, na, 0, sos, false, true, NULL, NULL);
                //stringstream s2;
                llena_ss(s2, na);
                delete na;
                ...
                na = new NodoTrieS("a", NULL, nb);
                //llena_ss(sis2, na);
                mezclaDiscoRam(sis1, na, 0, sos, true, false, NULL, NULL);
                delete na;
                ...
                */
                ...
                na = new NodoTrieS("a");
                //llena_ss(sis2, na);
                mezclaDiscoRam(sis1, na, 0, sos, false, false, NULL, NULL);
                delete na;
                ...
                renum.push_back(0);
                mezclaDiscoRam(sis1, na, 0, sos, true, true, NULL, &renum);
                delete na;
                ...
                sis1.seekg(MARCAIND.length() + 1);
                //sis2.seekg(MARCAIND.length() + 1);
                mezclaDiscoRam(sis1, na, 0, sos, true, true, &renum1, &renum);
                delete na;
